  ...
  <div class="container-scroller">
    ...
    <!-- partial:../../partials/_sidebar.html -->
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/clones/igotit/seller/home">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="create_add">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="http://localhost/clones/igotit/seller/uploadproduct">ADD Products</a></li>
              </ul>
            </div>
          </li>
          <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="http://localhost/clones/igotit/seller/product">Product</a></li>
              </ul>
            </div>
          </li>
          <!-- <li class="nav-item">
