<div class="col-lg-4 mx-auto">
  <div class="auth-form-light text-left py-5 px-4 px-sm-5">
    ...
    <form class="pt-3" method="post" id="seller_register">
      ...
      <div class="form-group">
        <label>File</label>
        <input type="file" name="seller_file" required class="form-control form-control-lg" id="seller_file" placeholder="Password">
      ...
      <div class="form-group">
        <label>Phone</label>
        <input class="form-control" id="seller_phone" name="seller_phone" type="tel" placeholder="+123 456 789" required>
      <span id="seller_phone_error" class="text-danger bold" style="display:none;" >please Provide Phone Number</span>
      </div>
      <div class="form-group">
        <label>Addres</label>
        <input class="form-control" id="seller_addres" name="seller_addres" type="text" placeholder="123 Street" required>
      ...
      <div class="mb-4">
        <div class="form-check">
          <label class="form-check-label text-muted">
            <input type="checkbox" id="seller_terms" name="seller_terms" class="form-check-input" required>
  ...
  $(document).ready(function() {
    ...
    $('#seller_register').on('submit', function(e) {
      ...
      spanErrorArray = validate_data({
       ...
       "#seller_country_error": ($("[name='country]", '#seller_register').prop('selected', true)&&$("[name='country]", '#seller_register').prop('selected', true).is(':selected'))?true:false,
