...
<form class="login container" id="register">
<div class="col-lg-8">
      <div class="mb-4">
      ...
      <div class="card-footer border-secondary bg-transparent">
          <button type="submit" name="register" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">Create Account</button>
      </div>
  </div>
</form>
